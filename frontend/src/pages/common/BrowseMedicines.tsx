        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16 sm:h-20 gap-2 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => navigate('/')}>
              ...
              <span className="text-xl sm:text-3xl font-bold gradient-text">MediMitra</span>
            </div>
            <button onClick={() => navigate('/login-user')} className="btn btn-primary text-sm sm:text-base px-3 sm:px-6 py-2 whitespace-nowrap">
              Sign In
            </button>
          </div>
        </div>
